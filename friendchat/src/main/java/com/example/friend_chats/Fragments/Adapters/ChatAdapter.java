...
import com.example.friend_chats.Models.MessageModel;
import com.example.friend_chats.R;
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String senderRom = FirebaseAuth.getInstance().getUid() + recId;
                                database.getReference().child("chats").child(senderRom)
